...
class AddHospitalVisitInfo extends StatelessWidget {
  ...
  const AddHospitalVisitInfo({super.key, required this.summaryController, required this.consultantController, required this.checkBox, required this.dropDown});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children:
        // addVisitText('Date of Admission', data.admissionDate) +
        // addVisitText('Date Discharged', data.dischargeDate) +
